...
from training.Train_Prune_Model import Prune_Train
...
def main(exp_name,
    ...
    techer_model_path = '/home/sihao/Desktop/logs/Old_1111/20230328_2052/checkpoint_best_mAP.pth'
    ...
    train = Prune_Train(
        ...
        device=device,
        EP_list=retain_block,
        techer_model_path = techer_model_path
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch_size", "-b", help="batch size", type=int, default=1)
    ...
    parser.add_argument("--coco_root_path", help="COCO dataset root path", type=str, default="/home/sihao/Desktop/COCO")
